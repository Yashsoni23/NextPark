        ...
        <ModalContent>
          {(onClose) => (
            <>
              {step === 1 && (
                <>
                  <ModalHeader>Please Select Further Information</ModalHeader>
                  <ModalBody>
                    <RadioGroup
                    ...
                    <div className="flex justify-between mt-2 flex-wrap gap-2">
                      {[1, 2, 3, 4, 5, 6].map((hour) => (
                        <Button
                          key={hour}
                          color={
                            formData.duration === hour ? "primary" : "default"
                          }
                          variant="solid"
                ...
                >
                  ...
                  <ModalBody className="text-left">
                    <p className="text-gray-600 text-center">
                      Scan this QR on the scanner machine when you are in the
                      parking lot.
                    </p>
